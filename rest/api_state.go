...
*/
func (a *StateApiService) GetAccount(ctx context.Context, address string) ApiGetAccountRequest {
	return ApiGetAccountRequest{
		ApiService: a,
		ctx:        ctx,
		address:    address,
...
//  @return Account
func (a *StateApiService) GetAccountExecute(r ApiGetAccountRequest) (*Account, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetAccount")
	if err != nil {
...
*/
func (a *StateApiService) GetAccountModule(ctx context.Context, address string, moduleName string) ApiGetAccountModuleRequest {
	return ApiGetAccountModuleRequest{
		ApiService: a,
		ctx:        ctx,
		address:    address,
...
// Execute executes the request
//  @return MoveModule
func (a *StateApiService) GetAccountModuleExecute(r ApiGetAccountModuleRequest) (*MoveModule, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetAccountModule")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *StateApiService) GetAccountModules(ctx context.Context, address string) ApiGetAccountModulesRequest {
	return ApiGetAccountModulesRequest{
		ApiService: a,
		ctx:        ctx,
		address:    address,
...
// Execute executes the request
//  @return []MoveModule
func (a *StateApiService) GetAccountModulesExecute(r ApiGetAccountModulesRequest) ([]MoveModule, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetAccountModules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *StateApiService) GetAccountResource(ctx context.Context, address string, resourceType string) ApiGetAccountResourceRequest {
	return ApiGetAccountResourceRequest{
		ApiService:   a,
		ctx:          ctx,
		address:      address,
...
func (a *StateApiService) GetAccountResourceExecute(r ApiGetAccountResourceRequest) (*AccountResource, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetAccountResource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *StateApiService) GetAccountResources(ctx context.Context, address string) ApiGetAccountResourcesRequest {
	return ApiGetAccountResourcesRequest{
		ApiService: a,
		ctx:        ctx,
		address:    address,
...
// Execute executes the request
//  @return []AccountResource
func (a *StateApiService) GetAccountResourcesExecute(r ApiGetAccountResourcesRequest) ([]AccountResource, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetAccountResources")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetTableItemRequest struct {
	ctx              context.Context
	ApiService       *StateApiService
	tableHandle      string
...
// Table item request
func (r ApiGetTableItemRequest) TableItemRequest(tableItemRequest TableItemRequest) ApiGetTableItemRequest {
	r.tableItemRequest = &tableItemRequest
	return r
}

func (r ApiGetTableItemRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.GetTableItemExecute(r)
}

/*
GetTableItem Get table item by handle and key.
...
Key and value types need to be passed in to help with key serialization and value deserialization.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param tableHandle
 @return ApiGetTableItemRequest
*/
func (a *StateApiService) GetTableItem(ctx context.Context, tableHandle string) ApiGetTableItemRequest {
	return ApiGetTableItemRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *StateApiService) GetTableItemExecute(r ApiGetTableItemRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StateApiService.GetTableItem")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tables/{table_handle}/item"
	localVarPath = strings.Replace(localVarPath, "{"+"table_handle"+"}", url.PathEscape(parameterToString(r.tableHandle, "")), -1)
