...
func (obj *BlockMetadata) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_AccountAddress(obj.PreviousBlockVotes, serializer); err != nil {
		return err
	}
...
func load_CoinTradeMetadata__CoinTradeMetadataV0(deserializer serde.Deserializer) (CoinTradeMetadata__CoinTradeMetadataV0, error) {
	...
	if val, err := DeserializeCoinTradeMetadataV0(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *CoinTradeMetadataV0) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_str(obj.TradeIds, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_GeneralMetadata__GeneralMetadataVersion0(deserializer serde.Deserializer) (GeneralMetadata__GeneralMetadataVersion0, error) {
	...
	if val, err := DeserializeGeneralMetadataV0(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *GeneralMetadataV0) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_bytes(obj.ToSubaddress, serializer); err != nil {
		return err
	}
	if err := serialize_option_bytes(obj.FromSubaddress, serializer); err != nil {
		return err
	}
	if err := serialize_option_u64(obj.ReferencedEvent, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeGeneralMetadataV0(deserializer serde.Deserializer) (GeneralMetadataV0, error) {
	...
	if val, err := deserialize_option_bytes(deserializer); err == nil {
		obj.ToSubaddress = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_bytes(deserializer); err == nil {
		obj.FromSubaddress = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_u64(deserializer); err == nil {
		obj.ReferencedEvent = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_Metadata__GeneralMetadata(deserializer serde.Deserializer) (Metadata__GeneralMetadata, error) {
	...
	if val, err := DeserializeGeneralMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Metadata__TravelRuleMetadata(deserializer serde.Deserializer) (Metadata__TravelRuleMetadata, error) {
	...
	if val, err := DeserializeTravelRuleMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Metadata__UnstructuredBytesMetadata(deserializer serde.Deserializer) (Metadata__UnstructuredBytesMetadata, error) {
	...
	if val, err := DeserializeUnstructuredBytesMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Metadata__RefundMetadata(deserializer serde.Deserializer) (Metadata__RefundMetadata, error) {
	...
	if val, err := DeserializeRefundMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Metadata__CoinTradeMetadata(deserializer serde.Deserializer) (Metadata__CoinTradeMetadata, error) {
	...
	if val, err := DeserializeCoinTradeMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Metadata__PaymentMetadata(deserializer serde.Deserializer) (Metadata__PaymentMetadata, error) {
	...
	if val, err := DeserializePaymentMetadata(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_PaymentMetadata__PaymentMetadataVersion0(deserializer serde.Deserializer) (PaymentMetadata__PaymentMetadataVersion0, error) {
	...
	if val, err := DeserializePaymentMetadataV0(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *PaymentMetadataV0) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_array16_u8_array(obj.ReferenceId, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *RawTransaction) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeStr(obj.GasCurrencyCode); err != nil {
		return err
	}
...
func load_RefundMetadata__RefundMetadataV0(deserializer serde.Deserializer) (RefundMetadata__RefundMetadataV0, error) {
	...
	if val, err := DeserializeRefundMetadataV0(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *RefundMetadataV0) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.TransactionVersion); err != nil {
		return err
	}
	if err := obj.Reason.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeRefundMetadataV0(deserializer serde.Deserializer) (RefundMetadataV0, error) {
	...
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.TransactionVersion = val
	} else {
		return obj, err
	}
	if val, err := DeserializeRefundReason(deserializer); err == nil {
		obj.Reason = val
	} else {
		return obj, err
	}
...
func load_TravelRuleMetadata__TravelRuleMetadataVersion0(deserializer serde.Deserializer) (TravelRuleMetadata__TravelRuleMetadataVersion0, error) {
	...
	if val, err := DeserializeTravelRuleMetadataV0(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *TravelRuleMetadataV0) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_str(obj.OffChainReferenceId, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *UnstructuredBytesMetadata) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_bytes(obj.Metadata, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func serialize_option_bytes(value *[]byte, serializer serde.Serializer) error {
	if value != nil {
		...
		if err := serializer.SerializeBytes((*value)); err != nil {
			return err
		}
	} else {
